...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kontact-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kontact-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kontact-23.04.1
cd %{_builddir}/kontact-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684865954
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkontactprivate.so.5
/V3/usr/lib64/libkontactprivate.so.5.23.1
/V3/usr/lib64/qt5/plugins/pim5/kcms/kontact/kcm_kontact.so
/usr/lib64/libkontactprivate.so.5
/usr/lib64/libkontactprivate.so.5.23.1
