...
Version  : 19.12.2
Release  : 8
URL      : https://download.kde.org/stable/release-service/19.12.2/src/kontact-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kontact-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kontact-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kontact-19.12.2
cd %{_builddir}/kontact-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581094805
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kontact-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kontact/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kontact-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kontact/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kontact-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kontact/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kontact
...
/usr/lib64/libkontactprivate.so.5.13.2
