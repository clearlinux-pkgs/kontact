...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/kontact-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/kontact-22.08.2.tar.xz.sig
...
%prep
%setup -q -n kontact-22.08.2
cd %{_builddir}/kontact-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665766335
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkontactprivate.so.5.21.2
