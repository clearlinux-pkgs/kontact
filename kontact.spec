...
Version  : 24.02.0
Release  : 71
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kontact-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kontact-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kontact-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kontact-24.02.0
cd %{_builddir}/kontact-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710455538
mkdir -p clr-build
pushd clr-build
