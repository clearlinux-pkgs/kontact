...
Version  : 23.08.1
Release  : 59
URL      : https://download.kde.org/stable/release-service/23.08.1/src/kontact-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/kontact-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/kontact-23.08.1.tar.xz.sig
...
%prep
%setup -q -n kontact-23.08.1
cd %{_builddir}/kontact-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695095541
mkdir -p clr-build
pushd clr-build
