...
%prep
%setup -q -n kontact-23.04.2
cd %{_builddir}/kontact-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686542331
mkdir -p clr-build
pushd clr-build
