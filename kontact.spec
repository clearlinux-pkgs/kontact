...
Version  : 22.12.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/22.12.1/src/kontact-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kontact-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kontact-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kontact-22.12.1
cd %{_builddir}/kontact-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673312958
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkontactprivate.so.5.22.1
