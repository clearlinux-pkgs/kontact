...
Version  : 22.08.0
Release  : 35
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kontact-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kontact-22.08.0.tar.xz
...
%prep
%setup -q -n kontact-22.08.0
cd %{_builddir}/kontact-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661563828
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkontactprivate.so.5.21.0
