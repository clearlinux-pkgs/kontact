...
%setup -q -n kontact-24.08.1
cd %{_builddir}/kontact-24.08.1
pushd ..
cp -a kontact-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726266537
mkdir -p clr-build
pushd clr-build
