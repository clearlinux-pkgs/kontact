...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/kontact-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/kontact-22.04.2.tar.xz.sig
...
%prep
%setup -q -n kontact-22.04.2
cd %{_builddir}/kontact-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654871350
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kontact-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kontact/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/kontact-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kontact/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kontact-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kontact/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kontact-22.04.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kontact-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kontact-22.04.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kontact/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kontact-22.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang kontact
...
/usr/lib64/libkontactprivate.so.5.20.2
