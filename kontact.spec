...
%prep
%setup -q -n kontact-20.12.3
cd %{_builddir}/kontact-20.12.3
...
cp %{_builddir}/kontact-20.12.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kontact
...
/usr/lib64/libkontactprivate.so.5.16.3
