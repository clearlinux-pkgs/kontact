...
Version  : 22.08.1
Release  : 36
URL      : https://download.kde.org/stable/release-service/22.08.1/src/kontact-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kontact-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kontact-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kontact-22.08.1
cd %{_builddir}/kontact-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662828856
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkontactprivate.so.5.21.1
