...
Version  : 21.08.1
Release  : 23
URL      : https://download.kde.org/stable/release-service/21.08.1/src/kontact-21.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.1/src/kontact-21.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.1/src/kontact-21.08.1.tar.xz.sig
...
%prep
%setup -q -n kontact-21.08.1
cd %{_builddir}/kontact-21.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630969025
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kontact-21.08.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kontact/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kontact-21.08.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kontact/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kontact-21.08.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kontact-21.08.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kontact/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kontact
...
/usr/lib64/libkontactprivate.so.5.18.1
